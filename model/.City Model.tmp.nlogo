; Allgemeiner Code, in diesem Bereich nichts ändern: ----------------------------------------------------------------------------------------
...
to plan-laden
  ...
  let karte-link (word "https://https://https://raw.githubusercontent.com/JohnnaFly/MINTpink/main/maps/Gruppe-1.jpg"Gruppennummer".jpg")
...
to-report bestimme-aufenthaltszeit [nächstes-ziel]
  ...
  ; Festlegen von Aufenthaltszeiten je nach Flächenart
  let aufenthaltszeit-grünflächen 150
  let aufenthaltszeit-einkaufsmöglichkeiten 100
  let aufenthaltszeit-geschäftsräume 400
  let aufenthaltszeit-wohngebäude 800
  let aufenthaltszeit-soziale-einrichtungen 100
  ...
  let zeit (ifelse-value
    member? nächstes-ziel grünflächen [aufenthaltszeit-grünflächen]
    member? nächstes-ziel einkaufsmöglichkeiten [aufenthaltszeit-einkaufsmöglichkeiten]
    member? nächstes-ziel geschäftsräume [aufenthaltszeit-geschäftsräume]
    member? nächstes-ziel wohngebäude [aufenthaltszeit-wohngebäude]
    member? nächstes-ziel soziale-einrichtungen [aufenthaltszeit-soziale-einrichtungen]
    [0]
  )
...
to-report bestimme-fröhlichkeit-veränderung [aktueller-ort]
  ...
  ; Festlegen von Fröhlichkeit je nach Flächenart
  let fröhlichkeit-grünflächen 0.5
  let fröhlichkeit-einkaufsmöglichkeiten 0.2
  let fröhlichkeit-geschäftsräume -0.2
  let fröhlichkeit-wohngebäude 0
  let fröhlichkeit-soziale-einrichtungen 0.5

  ; Veränderung bestimmen, je nachdem wo sich eine Person gerade befindet
  let veränderung (ifelse-value
    member? aktueller-ort grünflächen [fröhlichkeit-grünflächen]
    member? aktueller-ort einkaufsmöglichkeiten [fröhlichkeit-einkaufsmöglichkeiten]
    member? aktueller-ort geschäftsräume [fröhlichkeit-geschäftsräume]
    member? aktueller-ort wohngebäude [fröhlichkeit-wohngebäude]
    member? aktueller-ort soziale-einrichtungen [fröhlichkeit-soziale-einrichtungen]
    [0]
  )
...
; Funktion zum Bestimmen der durchschnittlichen Fröhlichkeit, nur für die Anzeige des Graphen
to-report durchschnittliche-fröhlichkeit

  ifelse (count menschen) < 1 [
    report 0
  ][
    report mean [fröhlichkeit] of menschen
  ]
